...
std::string ReplaceFunctionWithSplitFunction(std::string Word, std::string WordToReplace, std::string ReplaceTo, const std::string Delemiter, bool MatchCase =  false);