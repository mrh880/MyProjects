...
void SaveClientsInfoFromVectorToFile(const string &FileName, const vector<stClientInfo> &ClientsInfo)
{
    string FilePath = FilesOperations::GetFullPathOfFile(FileName);

    fstream UserFile;

    FilesOperations::OpenFile(UserFile, enFileMode::Append, FilePath);
